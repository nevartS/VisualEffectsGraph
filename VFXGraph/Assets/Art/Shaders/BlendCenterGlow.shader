Shader "HiGames/Particles/BlendCenterGlow"
{
    Properties
    {
        ...
        _Mask("Mask", 2D) = "white" {}
        _MainTexSpeedUV_NoiseZ("MainTextureSpeedUV_NoiseZ", Vector) = (0,0,0,0)
        _DistortionSpeedXY_PowerZ("DistoritonSpeedXY_PowerZ", Vector) = (0,0,0,0)
        ...
        [Enum(Cull Off,0, Cull Front,1, Cull Back,2)] _CullingMode("Culling", Float) = 0
